...
public class App {
	...
	private void initialize() {
		...
		mntmVolver = new JMenuItem("VolverBienvenida");
		ActionListener listenerVolver= new ActionListener() {
		...
		mntmVolver.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_B, InputEvent.CTRL_DOWN_MASK));
		
		mntmVolver.addActionListener(listenerVolver);
